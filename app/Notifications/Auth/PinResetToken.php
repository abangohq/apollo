...
class PinResetToken extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ...
            ->greeting("Hi {$name},")
            ->line("To proceed further with your pin reset process on {$appName} please use the OTP below")
            ...
            ->line('Please note that this OTP will only be valid for 5 minutes.');
    }
